        ...
        if mode == 'teacher' or mode == 'distillation' or mode == 'distillation_ft':
                ...
                if teacher_model == "CNN_14":
                    ...
                    teacher_model_ft = WhisperEncoderFromSpec(
                        ...
                        use_pretrained=True,  # will load from local path
                        freeze_encoder=False,
                        feature_source="layer2",
                        local_checkpoint_path="./Model Weights/whisper_tiny.pt",  # update path
                        strict_load=False
                    )
        ...
        if mode == 'teacher' or mode == 'distillation' or mode == 'distillation_ft':
            ...
            if teacher_model == 'HuBERTBase':
                ...
                teacher_model_ft = Wav2Vec2AudioEncoder(
                    ...
                    freeze_encoder=False,
                    sample_rate_in=32000,
                    feature_source="cnn",                          # "cnn" | "last_hidden" | "layer2"
                    local_checkpoint_path="./Model Weights/wav2vec2_base.pt",
                    strict_load=False
                )
