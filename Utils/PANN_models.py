...
class Cnn14(nn.Module):
    def __init__(self, sample_rate, window_size, hop_size, mel_bins, fmin, 
        ...
        # #Move custom layers to the specified device
    ...
    #     for param in self.custom_cdm_layer.parameters():
    #         param.requires_grad = True
    #     for param in self.custom_ditm_layer.parameters():
    #         param.requires_grad = True
